...
import 'package:math_solver_app/src/data/repository/magic_triangle_repository.dart';
import 'package:math_solver_app/src/data/repository/math_grid_repository.dart';
import 'package:math_solver_app/src/data/repository/number_pyramid_repository.dart';
import 'package:math_solver_app/src/ui/app/time_provider.dart';
import 'package:math_solver_app/src/ui/dashboard/dashboard_provider.dart';
import 'package:math_solver_app/src/data/repository/calculator_repository.dart';
import 'package:math_solver_app/src/data/repository/correct_answer_repository.dart';
import 'package:math_solver_app/src/data/repository/math_pairs_repository.dart';
import 'package:math_solver_app/src/data/repository/mental_arithmetic_repository.dart';
import 'package:math_solver_app/src/data/repository/picture_puzzle_repository.dart';
import 'package:math_solver_app/src/data/repository/quick_calculation_repository.dart';
import 'package:math_solver_app/src/data/repository/square_root_repository.dart';
import 'package:math_solver_app/src/data/repository/sign_repository.dart';
